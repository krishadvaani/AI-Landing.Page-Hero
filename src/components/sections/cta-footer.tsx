...
// import { Link } from 'next/link'; // Next.js uses Link from next/link
  ...
  return (
    <section className="relative w-full min-h-[800px] flex flex-col items-center justify-end overflow-hidden pt-32">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-3xl mx-auto w-full mb-20">
        ...
        >
          <button className="bg-white/10 backdrop-blur-md border border-white/20 hover:scale-105 transition-transform duration-300 rounded-full px-8 py-3.5 text-white font-medium text-sm w-full sm:w-auto">
            Book a Call
          </button>
