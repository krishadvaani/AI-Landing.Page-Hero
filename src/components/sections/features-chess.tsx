    ...
    <section className="w-full max-w-7xl mx-auto px-6 py-24 md:py-32 flex flex-col gap-24 md:gap-32">
      ...
      <div className="flex flex-col items-center text-center mb-8">
        <motion.div 
          ...
          viewport={{ once: true }}
          className="bg-white/5 backdrop-blur-md border border-white/10 rounded-full px-4 py-1.5 mb-6"
        >
      ...
      <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        ...
        >
          ...
          <button className="bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-colors rounded-full px-6 py-3 text-white font-medium text-sm mt-4">
            Learn more
          </button>
        </motion.div>
        ...
        >
          <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-2 w-full aspect-video md:aspect-[4/3] overflow-hidden group">
            <img 
