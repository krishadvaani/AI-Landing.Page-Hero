      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {features.map((feature, idx) => (
          <motion.div
            ...
            className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8 hover:-translate-y-1 transition-transform duration-300"
          >
            <div className="bg-white/10 backdrop-blur-sm border border-white/10 rounded-full w-12 h-12 flex items-center justify-center mb-6">
